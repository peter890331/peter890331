...
5. 遊戲輔助網頁：寶可補給站選秀會 - 潛在座標查詢器 - 中文版 (Pokémon Go)      
...
6. 遊戲輔助網頁：PokeStop Showcase - Potential Coords Finder - English Version (Pokémon Go)      
...
7. 遊戲腳本：new_autoshinyhunter_gui_version (Pokémon Go)      
...
8. 遊戲腳本：Beat_Team_Rocket_App (Pokémon Go)      
